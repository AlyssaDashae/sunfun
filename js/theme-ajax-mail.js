...
$(function () {
    ...
    $('#contact-form2').submit(function (event) {
        ...
        $.ajax({
            type: "POST",
            url: "assets/php/contact-form2.php",
            data: dataString,
            success: function () {
                $('#contact-form2').prepend("<div class=\"alert alert-success fade in\" style='margin: 10px;'><button class=\"close\" data-dismiss=\"alert\" type=\"button\">&times;</button><strong>Contact Form Submitted!</strong> We will be in touch soon.</div>");
